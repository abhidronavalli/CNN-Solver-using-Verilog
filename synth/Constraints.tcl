...
#
 ...
 set SRAM_DELAY [expr 0.02 + 4.000]
 set_input_delay $SRAM_DELAY -clock $clkname [get_ports *__dut__data]
...
#---------------------------------------------------------
 ...
 set_output_delay $SRAM_DELAY -clock $clkname [get_ports dut__*__write]
 set_output_delay $SRAM_DELAY -clock $clkname [get_ports dut__*__address]
 set_output_delay $SRAM_DELAY -clock $clkname [get_ports dut__*__data]
 set_output_delay $SRAM_DELAY -clock $clkname [get_ports dut__*__enable]
